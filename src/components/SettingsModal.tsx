...
function SettingsModal({ strokeWidth }: { strokeWidth: number }) {
  ...
  return (
    <>
      <div
        className="tooltip tooltip-left absolute top-1 right-1 p-1 flex items-center justify-center hover:bg-black/10 rounded-full"
      ...
      <dialog id="settings-modal" className="modal">
        <div className="modal-box max-h-[90vh]">
          <h3 className="font-bold text-lg">Configuration Settings</h3>
          <p className="pt-4">
            Listed below are one or more options you can adjust to change how
